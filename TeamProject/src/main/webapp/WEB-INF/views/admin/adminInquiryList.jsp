      ...
      <div class="container-table100">      
	    <div class="wrap-table100">
	      ...
	      <div style="display: flex; float: right" class="searchDiv2">
	        <form name="form1" method="post" action="adminInquiry.do" style="display: contents">
	          <input type="radio" name="inqOk" value="2" checked>전체
              <input type="radio" name="inqOk" value="0">대기중
              <input type="radio" name="inqOk" value="1">완료       
		  ...
		  <div class="table">
            ...
            <c:forEach var="dto" items="${map.adminListInquiry}">
			<div class="row">
			  <div class="cell" data-title="inqNum">
			    ${dto.inqNum}
			  </div>
			  <div class="cell" data-title="inqSubject">
			    <a href="adminInqContent.do?inqNum=${dto.inqNum}">${dto.inqSubject}</a>
			  </div>
