      ...
      <div class="container-table100">      
	    <div class="wrap-table100">
	      ...
	      <div class="subCount" style="display: flex; float: left; margin-top: 10px;">
	        ...
	        <a href="blockMemberList.do">정지회원</a>
	        </div>
	      </div>
	      
	      <!-- 검색란 -->
	      <div style="display: flex; float: right" class="searchDiv">
	        <form name="form1" method="post" action="memberList.do" style="display: contents">
		  ...
		  <div class="table">
            ...
            <c:forEach var="dto" items="${map.memberList}">
			<div class="row">
			  ...
			  <div class="cell" data-title="userBlock" id="cellBlock">
			    <a href="adminBlock.do?userNum=${dto.userNum}" onclick="return checkBlock()">정지</a> 
